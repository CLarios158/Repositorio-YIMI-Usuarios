...
import { Text, View, StyleSheet, TextInput, TouchableNativeFeedback, StatusBar, AsyncStorage } from 'react-native';
    ...
    try {
      ...
      if (res.status == 200) {
        res.data.data.forEach(element => {
          ...
          this.props.navigation.navigate('Principal', { id_usuario: this.state.id_usuario });
        });
      } else {
